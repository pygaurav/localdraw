...
const files = readdirSync(`${__dirname}/../packages/localdraw/locales`);
...
for (let index = 0; index < locales.length; index++) {
  ...
  const data = flatten(
    require(`${__dirname}/../packages/localdraw/locales/${currentLocale}`),
  );
...
writeFileSync(
  `${__dirname}/../packages/localdraw/locales/percentages.json`,
