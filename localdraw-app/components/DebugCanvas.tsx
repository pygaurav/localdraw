...
import { arrayToMap, throttleRAF } from "@localdraw/common";
...
import { isCurve } from "@localdraw/math/curve";

import React from "react";

import type { Curve } from "@localdraw/math";
import type {
  DebugElement,
  DebugPolygon,
} from "@localdraw/element/visualdebug";
import type {
  ElementsMap,
...
import { getPrefsCache, updatePrefs } from "../data/prefsCache";
...
export const saveDebugState = (debug: { enabled: boolean }) => {
  updatePrefs({ debugEnabled: debug.enabled });
};
...
export const loadSavedDebugState = (): { enabled: boolean } => {
  return { enabled: getPrefsCache().debugEnabled };
};
