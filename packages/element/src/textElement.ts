...
import { pointFrom, pointRotateRads, type Radians } from "@localdraw/math";

import type { AppState } from "@excalidraw/excalidraw/types";

import type { ExtractSetType } from "@localdraw/common/utility-types";
...
export const getContainerCoords = (container: NonDeletedExcalidrawElement) => {
  ...
  if (container.type === "ellipse") {
    // The derivation of coordinates is explained in https://github.com/localdraw/localdraw/pull/6172
    offsetX += (container.width / 2) * (1 - Math.sqrt(2) / 2);
    offsetY += (container.height / 2) * (1 - Math.sqrt(2) / 2);
  }
  // The derivation of coordinates is explained in https://github.com/localdraw/localdraw/pull/6265
...
export const getBoundTextMaxWidth = (
  ...
  if (container.type === "ellipse") {
    ...
    // equation of an ellipse -https://github.com/localdraw/localdraw/pull/6172
    return Math.round((width / 2) * Math.sqrt(2)) - BOUND_TEXT_PADDING * 2;
  }
  if (container.type === "diamond") {
    // The width of the largest rectangle inscribed inside a rhombus is
    // Math.round(width / 2) - https://github.com/localdraw/localdraw/pull/6265
...
export const getBoundTextMaxHeight = (
  ...
  if (container.type === "diamond") {
    ...
    // Math.round(height / 2) - https://github.com/localdraw/localdraw/pull/6265
