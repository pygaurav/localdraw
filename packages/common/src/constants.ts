...
export const APP_NAME = "LocalDraw";
...
export enum EVENT {
  ...
  SCROLL = "scroll",
  // custom events
  LOCALDRAW_LINK = "localdraw-link",
  EXCALIDRAW_LINK = "localdraw-link",
...
export const STRING_MIME_TYPES = {
  ...
  // localdraw data
  localdraw: "application/vnd.localdraw+json",
  excalidraw: "application/vnd.localdraw+json",
  localdrawClipboard: "application/vnd.localdraw.clipboard+json",
  excalidrawClipboard: "application/vnd.localdraw.clipboard+json",
  excalidrawClipboardWithAPI: "localdraw-api/clipboard",
  // LEGACY: fully-qualified library JSON data
  localdrawlib: "application/vnd.localdrawlib+json",
  excalidrawlib: "application/vnd.localdrawlib+json",
  // list of localdraw library item ids
  localdrawlibIds: "application/vnd.localdrawlib.ids+json",
  excalidrawlibIds: "application/vnd.localdrawlib.ids+json",
} as const;

export const MIME_TYPES = {
  ...STRING_MIME_TYPES,
  // image-encoded localdraw data
  "localdraw.svg": "image/svg+xml",
  "excalidraw.svg": "image/svg+xml",
  "localdraw.png": "image/png",
...
export const EXPORT_DATA_TYPES = {
  localdraw: "localdraw",
  excalidraw: "localdraw",
  localdrawClipboard: "localdraw/clipboard",
  excalidrawClipboard: "localdraw/clipboard",
  localdrawLibrary: "localdrawlib",
  excalidrawLibrary: "localdrawlib",
  localdrawClipboardWithAPI: "localdraw-api/clipboard",
  excalidrawClipboardWithAPI: "localdraw-api/clipboard",
} as const;

export const getExportSource = () =>
  window.LOCALDRAW_EXPORT_SOURCE || window.location.origin;
...
export const EDITOR_LS_KEYS = {
  OAI_API_KEY: "localdraw-oai-api-key",
