...
import { KEYS, arrayToMap, getLineHeight } from "@localdraw/common";

import { getElementBounds } from "@localdraw/element";
...
vi.mock("@localdraw/common", async (importOriginal) => {
