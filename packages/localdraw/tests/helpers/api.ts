...
import { pointFrom, type LocalPoint, type Radians } from "@localdraw/math";

import { DEFAULT_VERTICAL_ALIGN, ROUNDNESS, assertNever } from "@localdraw/common";
...
import { isLinearElementType } from "@localdraw/element";
import { getSelectedElements } from "@localdraw/element";
import { selectGroupsForSelectedElements } from "@localdraw/element";

import { FONT_SIZES } from "@localdraw/common";
...
import type { Mutable } from "@localdraw/common/utility-types";
