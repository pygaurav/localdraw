...
import type { LinearElementEditor } from "@localdraw/element";

import type { MaybeTransformHandleType } from "@localdraw/element";
...
import type { GlobalPoint } from "@localdraw/math";
...
export interface ExcalidrawProps {
  ...
  /** Render extra buttons inside the App-toolbar Island, after the shape tools */
  renderToolbarExtra?: () => JSX.Element | null;
