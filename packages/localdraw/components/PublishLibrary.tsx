import { exportToCanvas, exportToSvg } from "@localdraw/utils/export";
        ...
        <form onSubmit={onSubmit}>
          ...
          <span className="publish-library-note">
            <Trans
              ...
              link={(el) => (
                <a
                  href="https://github.com/localdraw/excalidraw-libraries#guidelines"
                  target="_blank"
          ...
          <div className="publish-library__fields">
            ...
            <span className="publish-library-note">
              <Trans
                ...
                link={(el) => (
                  <a
                    href="https://github.com/localdraw/excalidraw-libraries/blob/main/LICENSE"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    {el}
