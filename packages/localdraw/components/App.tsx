...
import type { GlobalPoint, LocalPoint, Radians } from "@localdraw/math";
...
import type { Mutable, ValueOf } from "@localdraw/common/utility-types";
...
class App extends React.Component<AppProps, AppState> {
          ...
          return (
            ...
            >
              <div
                ...
                //https://github.com/localdraw/localdraw/pull/6691#issuecomment-1607383938
                /*ref={(ref) => {
  ...
  private handleCanvasPointerMove = (
    ...
    if (
      ...
      if (
        ...
        // update the state. Check https://github.com/localdraw/localdraw/pull/5508 for more details.
        flushSync(() => {
          this.setState({
  ...
  private handleAppOnDrop = async (event: React.DragEvent<HTMLDivElement>) => {
    ...
    if (fileItems.length > 0) {
      const { file, fileHandle } = fileItems[0];
      if (file) {
        // Attempt to parse an localdraw/excalidrawlib file
