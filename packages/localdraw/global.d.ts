interface Window {
  ClipboardItem: any;
  __LOCALDRAW_SHA__: string | undefined;
  __EXCALIDRAW_SHA__: string | undefined;
  LOCALDRAW_ASSET_PATH: string | string[] | undefined;
  LOCALDRAW_THROTTLE_RENDER: boolean | undefined;
  DEBUG_FRACTIONAL_INDICES: boolean | undefined;
  LOCALDRAW_EXPORT_SOURCE: string;
