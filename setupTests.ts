...
import polyfill from "./packages/localdraw/polyfill";
import { yellow } from "./packages/localdraw/tests/helpers/colorize";
import { testPolyfills } from "./packages/localdraw/tests/helpers/polyfills";
...
vi.mock(
  "./packages/localdraw/fonts/ExcalidrawFontFace",
  async (importOriginal) => {
    const mod = await importOriginal<
      typeof import("./packages/localdraw/fonts/ExcalidrawFontFace")
    >();
